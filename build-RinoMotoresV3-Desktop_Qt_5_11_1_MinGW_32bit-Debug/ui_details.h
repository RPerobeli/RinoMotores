...
public:
    ...
    void setupUi(QDialog *Details)
    {
        ...
        Details->setStyleSheet(QStringLiteral("background-color:#fff"));
...
"color:#fff;"));
    ...
    void retranslateUi(QDialog *Details)
    {
        ...
        label_titulo->setText(QApplication::translate("Details", "Especifica\303\247\303\265es do Motor selecionado:", nullptr));
        BtnOK->setText(QApplication::translate("Details", "Ok", nullptr));
    } // retranslateUi
